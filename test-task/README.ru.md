...
> *«Все наши ивенты бурые, как за... застоявшийся кофе»*
>
...
Работа **индивидуальная**, таски идут строго по порядку — каждая опирается на предыдущие, перепрыгивать не стоит. Есть **два трека**; выбирайте по бэкенд-стеку, которым реально владеете, — вы должны быть способны *проверять* работу агента, а не просто применять её. Какой трек выбрали — напишите в первом же PR.
...
Devlog — не отчётность ради отчётности. Финал пилота — **защита**: созвон с тренером, где вы рассказываете о своей работе. Хороший devlog — это готовый конспект этого рассказа; без него через пару недель вы не вспомните и половины.
